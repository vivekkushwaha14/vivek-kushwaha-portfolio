      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        >
          <div className="space-y-6">
            ...
            <button
              onClick={copyEmail}
              className="flex items-center gap-2 text-accent font-bold text-sm group"
            >
            ...
            {developerInfo.socials.map((social) => {
              ...
              return (
                <a
                  ...
                  className="flex items-center gap-4 p-4 glass-card rounded-2xl group hover:border-accent/30 transition-all"
                >
                  <div className="p-3 bg-accent/10 rounded-xl text-accent group-hover:bg-accent group-hover:text-background transition-all">
                    <Icon size={24} />
                  </div>
                  <div>
