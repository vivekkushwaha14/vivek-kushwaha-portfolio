      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
        ...
        >
          ...
          <div className="pt-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
             <div className="glass-card p-5 rounded-xl border-l-2 border-text">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-1 gap-6">
          {aboutInfo.stats.map((stat, index) => (
            <motion.div
              ...
              className="glass-card p-8 rounded-2xl text-center lg:text-left"
            >
              <div className="relative z-10">
                <h3 className="text-4xl md:text-5xl font-semibold text-text mb-2">{stat.value}</h3>
